...
# This file is automatically run by adl when the plugin is built into a Dockerfile.
...
# Any install steps that will modify things in adl's data volume should instead
...
# adl will automatically install this python module for you so you should not
